...
class MustardUI_Configuration_SmartCheck(bpy.types.Operator):
    """Search for MustardUI configuration options based on the name of the model
    and its body"""
    ...
    def execute(self, context):
        ...
        if rig_settings.hair_collection is None:
            if len(hair_collections) == 1:
                ...
                print(
                    ...
                    "compatible with MustardUI naming "
                    "convention."
                )
            else:
                print(
            ...
            print(
                "\nMustardUI - Smart Check - Hair collection already defined. "
                "Skipping this part."
            )
        ...
        if self.smartcheck_settings:
            ...
            if rig_settings.model_body is not None:
                ...
                if addon_prefs.debug:
                    print(
                        "\nMustardUI - Smart Check - Could not check Body "
                        "Global Properties."
                    )
