...
class MustardUI_Configuration_SmartCheck(bpy.types.Operator):
    ...
    smartcheck_outfits: bpy.props.BoolProperty(name="Outfits",
                                               default=True,
    ...
    smartcheck_armature: bpy.props.BoolProperty(name="Armature",
                                                default=True,
    ...
    reset_current_collections: bpy.props.BoolProperty(name="Reset Current Bone Collections",
                                                      ...
                                                      description="If disabled, do not remote the current enabled bone "
                                                                  ...
                                                                  "MHX).")
    smartcheck_settings: bpy.props.BoolProperty(name="Global Settings",
                                                default=True,
