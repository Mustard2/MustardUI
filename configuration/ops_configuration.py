        ...
        if not obj.MustardUI_enable:
            ...
            if (
                ...
                if addon_prefs.debug:
                    print(
                        ...
                        "seems not to have the scale applied.\n This might generate "
            ...
            if tools_settings.autoeyelid_enable:
                if (
                    ...
                    self.report(
                        {"ERROR"},
                        "MustardUI - At least one shape key should be selected if Auto "
                        "Blink tool is enabled.",
                    )
                    return {"FINISHED"}
                ...
                try:
                    ...
                    if addon_prefs.debug:
                        print(
                            ...
                            "property index seems to be corrupted. Try to remove "
