...
def mustardui_active_object(context, config=0):
    ...
    # If Viewport Model Selection is enabled, the active object will be
    # the active object only if it is an armature
    ...
    # If Viewport Model Selection is false, use the UI with the armature selected in
    # the model panel
    else:
