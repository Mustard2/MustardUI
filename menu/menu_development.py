...
class PANEL_PT_MustardUI_Development(MainPanel, bpy.types.Panel):
    bl_idname = "PANEL_PT_MustardUI_Development"
...
def register():
    bpy.utils.register_class(PANEL_PT_MustardUI_Development)


def unregister():
    bpy.utils.unregister_class(PANEL_PT_MustardUI_Development)
