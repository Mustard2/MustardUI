...
class MustardUI_ArmatureBoneCollection(bpy.types.PropertyGroup):
    ...
    advanced: BoolProperty(
        default=False,
        name="Advanced",
        description="Enable Advanced layer.\nIf enabled, this layer will be shown in "
        "the UI only if Advanced settings is enabled in the UI settings",
    )
    ...
    # Icon
    icon: EnumProperty(name="Icon", items=mustardui_icon_list)

    # Function to remove the layer from the UI if the outfit switcher is enabled
    # This is to avoid having a bone collection in the UI that is working on the outfit
    # automatically
    ...
    outfit_switcher_collection: bpy.props.PointerProperty(
        name="Outfit/Hair",
        ...
        for bcoll in collections:
            ...
            if bcoll_settings.outfit_switcher_enable:
                check_coll = (
                    ...
                    == bcoll_settings.outfit_switcher_collection
                ...
                if rig_settings.extras_collection is not None:
                    check_coll = (
                        check_coll
                        or bcoll_settings.outfit_switcher_collection
                ...
                if bcoll_settings.outfit_switcher_object is None:
                    ...
                    outfit_switcher = bcoll_settings.outfit_switcher_object
                    bcoll.is_visible = (
                        armature_settings.outfits
                        and not outfit_switcher.MustardUI_outfit_visibility
                        and (check_coll or outfit_switcher.MustardUI_outfit_lock)
                    )
