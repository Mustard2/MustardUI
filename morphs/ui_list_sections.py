...
class MustardUI_Morphs_Section_Remove(bpy.types.Operator):
    """Remove the selected Morph Section from the UI.\nThis do NOT delete any data,
    it just prevents the Morphs from being shown in the UI"""
...
def register():
    bpy.utils.register_class(MUSTARDUI_UL_Morphs_Section_UIList)
    bpy.utils.register_class(MustardUI_Morphs_Section_UIList_Switch)
...
def unregister():
    del bpy.types.Armature.mustardui_morphs_section_uilist_index

    bpy.utils.unregister_class(MustardUI_Morphs_Section_Remove)
    bpy.utils.unregister_class(MustardUI_Morphs_Section_Add)
    bpy.utils.unregister_class(MustardUI_Morphs_Section_UIList_Switch)
    bpy.utils.unregister_class(MUSTARDUI_UL_Morphs_Section_UIList)
