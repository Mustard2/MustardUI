...
def set_morphs_default_values(context, arm, settings):
...
class MustardUI_DazMorphs_DefaultValues(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        set_morphs_default_values(context, arm, morphs_settings)
        ...
        if preset_default > -1:
            ...
            # Set the preset
            bpy.ops.mustardui.preset_apply(preset_type="MORPHS", reset_preset=False)
