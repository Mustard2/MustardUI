...
class MustardUI_Morphs_Optimize(bpy.types.Operator):
    """Enable/disable Morph Optimization.\nWhen enabled, the shape keys and drivers of the Morphs with null values are disabled to increase performance. When Morphs are frozen, they can not be changed."""  # noqa: E501
