...
class MustardUI_ToolsCreators_AddClothToHair(bpy.types.Operator):
    ...
    In Object Mode, it uses the active vertex group as the 'Pin Group'. If called in
    Edit Mode, the pin group is assigned to the selected vertices.
    ...
    quality: bpy.props.IntProperty(
        ...
        description="Sets the quality of the Physics simulation",
        default=7,
        min=1,
        soft_max=10,
    )
    collision_quality: bpy.props.IntProperty(
        ...
        description="Sets the quality of collisions evaluation during the simulation",
        default=2,
        min=1,
        soft_max=10,
    )
    timescale: bpy.props.FloatProperty(
        name="Speed Multiplier",
        description="Lower value will slow the simulation (more dragged effect)",
        default=1.0,
        min=0.0,
        soft_max=10.0,
        step=3,
    ...
    vertex_mass: bpy.props.FloatProperty(
        name="Vertex Mass",
        description="Mass of each vertex for gravity and inertia evaluations",
        default=1.0,
        min=0.0,
        soft_max=10.0,
        step=3,
    ...
    collision: bpy.props.BoolProperty(
        name="Collision", description="Enables collisions", default=True
    )
    self_collision: bpy.props.BoolProperty(
        name="Self Collision",
        description="Enables collisions between parts of the cage",
        default=False,
    )
    ...
    def execute(self, context):
        ...
        # Set simulation start and end to the same start and end frame values
        # of the scene
