...
class MustardUI_Settings(bpy.types.PropertyGroup):
    ...
    daz_morphs_error: BoolProperty(
        name="",
        description="Can not find the Daz Morph.\nRe-run the Check Morphs operator "
        "in the Configuration menu to solve this",
    )
...
# Handler to solve a missing UI when: developer mode is on, but the UI has been left
